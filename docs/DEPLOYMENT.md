...
JWT_ISSUER=https://store.merchant.com
JWT_AUDIENCE=https://store.merchant.com/admin
JWT_ACCESS_TTL_SECONDS=900
JWT_CLOCK_SKEW_SECONDS=30
JWT_ALGORITHM=HS256

REFRESH_COOKIE_NAME=project_sync_refresh
REFRESH_COOKIE_PATH=/api/v1/admin
REFRESH_COOKIE_DOMAIN=store.merchant.com
REFRESH_COOKIE_SECURE=true
REFRESH_COOKIE_SAME_SITE=Strict
REFRESH_TOKEN_TTL_SECONDS=2592000
REFRESH_TOKEN_SECURITY_SECRET=GENERATED_64_CHAR_HEX_SECRET

ORDER_SECURITY_SECRET=GENERATED_64_CHAR_HEX_SECRET
RATE_LIMIT_SECRET=GENERATED_64_CHAR_HEX_SECRET
NOTIFICATION_SECURITY_SECRET=GENERATED_64_CHAR_HEX_SECRET
